    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} MRDDOS_1 strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print("MRDDOS_1_BANNER")
    print()
    print(' USAGE: python MRDDOS_1.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        # Create an instance of MRDDOS_1 here
        MRDDOS_1_instance = MRDDOS_1(url)
        MRDDOS_1_instance.useragents = useragents
        MRDDOS_1_instance.nr_workers = workers
        MRDDOS_1_instance.method = method
        MRDDOS_1_instance.nr_sockets = socks

        # Call the fire method on the instance
        MRDDOS_1_instance.fire()
